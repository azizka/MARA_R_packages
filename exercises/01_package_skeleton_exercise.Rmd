...
Nowadays, R-package development relies heavily on two R-package that provide the necessary code: the `devtools` and the `usethis` package. To start building a package, we thus first load this package.
